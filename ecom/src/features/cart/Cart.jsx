...
const products = [
 ...
 const Cart = () => {
  ...
  const [open, setOpen] = useState(true)
   ...
   return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-white mt-10 flex justify-between ">

                  {/* needed portion  */}
                  
                  <div className="mt-8 py-2  max-w-6xl">
                <h2 className='text-xl py-3 text-grey-600 font-bold font-serif ' >Cart</h2>
...
big img sec */}
                  ...
                  <div className="mt-8 py-2  max-w-6xl  bg-slate-50">
