    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-white mt-10 flex justify-between py-6">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 shadow-xl rounded-md">
        <div className="lg:col-span-3">
          <form className=" p-10   bg-slate-50">
...
{/* /////////////// */}
      ...
      {address.map((person) => (
        <li key={person.email} className="flex justify-between gap-x-6 py-5 border-b-4">
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-end">
            ...
            <p className="text-sm leading-6 text-gray-500">{person.phone}</p>
