...
function AdminOrders() {
  ...
  const [effectTriggerer, setEffectTriggerer] = useState(true);
  ...
  const handleOrderStatus = (e, order) => {
    ...
    setEffectTriggerer((effectTriggerer) => !effectTriggerer);
    console.log(effectTriggerer);
  };

  const handleOrderPaymentStatus = (e, order) => {
    console.log(e.target.value);
    //! the first value is not getting picked
  ...
  //   //!for some reason the useeffect not running when the disp occuring --IMPORTANT
  //! using a effectTrigerer as dependency worked !
  useEffect(() => {
    console.log("useeffff");
    dispatch(fetchAllOrdersAsync());
  }, [dispatch, effectTriggerer]);

  return (
    <div className="overflow-x-auto m-16 my-6">
            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th className="py-3 px-10 text-left">Items</th>
                  <th
                    className="py-3 px-0 text-left cursor-pointer"
                    onClick={(e) =>
                      handleSort({
                        ...
                        <div key={index} className="flex items-center">
                          <div className="mr-2">
                            <img
                              ...
                              // ! it is being changed from item.product.thumbnail to item.title
                              src={item.thumbnail}
                              alt={item.title}
                            />
                          </div>
